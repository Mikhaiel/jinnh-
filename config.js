...
module.exports = {
    ...
    TAGM: process.env.TAG_REPLY === undefined ? '919544846609@s.whatsapp.net' : process.env.TAG_REPLY,
    ...
    CHANGER: process.env.CHANGE_BGM_TO === undefined ? 'one' : process.env.CHANGE_BGM_TO,
    DEMOTEMSG: process.env.DEMOTE_MESSAGE === undefined ? 'default' : process.env.DEMOTE_MESSAGE,
    BANMSG: process.env.BAN_MESSAGE === undefined ? 'default' : process.env.BAN_MESSAGE,
    AFKMSG: process.env.AFK_MESSAGE === undefined ? 'default' : process.env.AFK_MESSAGE,
    TAG: process.env.TAG_HEADER === undefined ? 'Hey Friends' : process.env.TAG_HEADER,
    THERI: process.env.THERI_LIST === undefined ? false : process.env.THERI_LIST,
